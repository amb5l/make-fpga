...
print('# each source spec is a list comprising library name and source file')
...
for s in args.sdf:
    print(' { '+s[:s.index(':')]+' '+s[s.index(':')+1:s.index('=')]+' '+s[s.index('=')+1:]+' }')
print('}')
print('')
...
print('quietly set vsim_tcl "set NumericStdNoWarnings 1; if [file exists wave.do] {do wave.do}; run -all; view wave; wave zoom full"')
...
print('        vcom {*}$vcom_args $src')
print('      } else {')
print('        vlog {*}$vlog_args $src')
print('      }')
...
print('# resimulate')
print('proc resim {} {')
print('  restart -f; run -all; view wave')
print('}')
print('')
print('# when this script is executed: initialise, compile all, simulate first run')
print('init')
print('com')
print('sim')
