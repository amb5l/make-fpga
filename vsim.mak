...
define rr_com
$(VSIM_DIR)/$(strip $2)/.touch/$(notdir $(strip $1)): $(strip $1) $(VSIM_DIR)/$1 $(if $(strip $4),$(VSIM_DIR)/$(strip $5)/.touch/$(notdir $(strip $4))) $(if $(filter dev,$(MAKECMDGOALS)),,$($MAKEFILE_LIST)) | $(VSIM_DIR)/$(strip $2)/.touch
	cd $(VSIM_DIR) && $(VCOM) \
